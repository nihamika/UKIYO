...
# Core Features
Search Bar: Users can type an anime name to get real-time results from the database.
Filtering: Filter the results accoding to their genre and format(TV/Movie)
Sorting: Sort the anime list by its rating and release date.
